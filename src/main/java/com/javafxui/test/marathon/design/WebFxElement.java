...
public interface WebFxElement {
	
	/**
	 * This method will click the element and take snap
	 * @param ele   - The WebFxElement (button/link/element) to be clicked
	 ...
	 * @param ele   - The WebFxElement (text field) in which the data to be entered
	 * @param data  - The data to be sent to the WebFxElement
	 * @see locateElement method in Browser Class
		 * @author vv.karumanassey
	 ...
	 * @param ele   - The WebFxElement (button/link/element) in which text to be retrieved
		 * @author vv.karumanassey
	 * @see locateElement method in Browser Class
	 */
	 ...
	 * @param ele   - The WebFxElement in which the text to be need to be verified
	 ...
	 * @param ele   - The WebFxElement in which the attribute value to be need to be verified
	 ...
	 * @param ele   - The WebFxElement to be checked
		 * @author vv.karumanassey
	 * @see locateElement method in Browser Class
	 ...
	 * @param ele   - The WebFxElement (Radio button, Checkbox) to be verified
