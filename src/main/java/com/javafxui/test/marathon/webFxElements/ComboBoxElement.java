...
public class ComboBoxElement {
	...
	public ComboBoxElement(WebElement element) {
		if (  !element.getTagName().toString().equalsIgnoreCase("combo-box") ||
		!element.getAttribute("StyleClass").toLowerCase().contains("combo-box")) {
	...
	//IMPORTANT :	comboBox.findElement(By.cssSelector(".::call-select('+value+')"));
	}
